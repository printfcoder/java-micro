...
/**
 * copied from sofastack/sofa-rpc/ClassUtils
 *
...
public final class ClassUtil {
    ...
    public static <T> T newInstance(Class<T> clazz) throws MicroRpcException {
        ...
        try {
            ...
            if (constructors == null || constructors.length == 0) {
                throw new MicroRpcException(500, "The " + clazz.getCanonicalName() + " has no default constructor!");
            }
        ...
        } catch (MicroRpcException e) {
            throw e;
        } catch (Throwable e) {
            throw new MicroRpcException(500, e.getMessage(), e);
        }
    }
    ...
    public static <T> T newInstanceWithArgs(Class<T> clazz, Class<?>[] argTypes, Object[] args)
        ...
        try {
            if (!(clazz.isMemberClass() && !Modifier.isStatic(clazz.getModifiers()))) {
                ...
                Constructor<T>[] constructors = (Constructor<T>[]) clazz.getDeclaredConstructors();
                if (constructors == null || constructors.length == 0) {
                    throw new MicroRpcException(500,
